---
description: Open all arena research agents side-by-side in terminal (shortcut for research-open)
---
# aigon-research-open
...
- `/aigon:research-open 05` — opens all arena agents side-by-side for research 05
...
3. Each pane is pre-loaded with the agent CLI and `/aigon:research-conduct <ID>` command
